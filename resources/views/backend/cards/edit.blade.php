...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card">
            ...
            <h5 class="card-title">Edit {{$card->identifier}} </h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <div class="row">
              <div class="col-md-12">
              <form role="form" action="{{route('bustravel.cards.update',$card->id)}}" method="POST">
              {{csrf_field() }}
              ...
              <div class="box-body">
                  <div class="row">
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="text"  name="identifier" value="{{$card->identifier}}" class="form-control {{ $errors->has('identifier') ? ' is-invalid' : '' }}" id="exampleInputEmail1" placeholder="Enter Number Plate" required>
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="number" name="balance" value="{{$card->balance}}"  class="form-control {{ $errors->has('balance') ? ' is-invalid' : '' }}" id="seating-capacity" placeholder="Enter Seating Capacity">
                      ...
                      <div class="form-group col-md-6 ">
                        ...
                        <input id="front-seats" type="number" name="name" value="{{$card->name}}"  class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" required>
                        @if ($errors->has('name'))
                            <span class="invalid-feedback">
                  ...
                  <div class="form-group col-md-6 ">
                    ...
                    <input type="text" name="phone_number" value="{{$card->phone_number}}"  class="form-control {{ $errors->has('phone_number') ? ' is-invalid' : '' }}" id="exampleInputEmail1" >
                    ...
                    @endif
                        ...
                        <div class=" col-md-3 form-group">
                            ...
                            <label class="radio-inline">
                              <input type="radio" id="Active" name="status" value="1"  @php echo $card->status == 1 ? 'checked' :  "" @endphp> Active</label>
                            </label>
                           <label class="radio-inline">
                              <input type="radio" id="Deactive" name="status" value="0"@php echo $card->status == 0 ? 'checked' :  "" @endphp > Deactive</label>
                           </label>
                        </div>
                  </div>
              </div>
