...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card">
            ...
            <h5 class="card-title">Edit Sms Template</h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="callout callout-info">
                            <h5>variables you can use in the sms [keep it at 100 chars]</h5>
            ...
            <div class="row">
              ...
              <div class="box-body">                
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input hidden name="operator_id" value="{{$sms_template->operator_id}}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="language" value="{{old('language')}}" class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" >
                            <option value="english" @if($sms_template->language == 'english') selected @endif>English</option>
                            <option value="french" @if($sms_template->language == 'french') selected @endif>French</option>
                            <option value="kinyarwanda" @if($sms_template->language == 'kinyarwanda') selected @endif>Kinyarwanda<option>
                        </select>
                         @error('language')
                            <small class="form-text invalid-feedback" >
                                {{ $message }}
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <textarea name="message" class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}">{{$sms_template->message}}</textarea>
