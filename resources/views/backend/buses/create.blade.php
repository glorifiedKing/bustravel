    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <h5 class="card-title">Add Bus Details</h5>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <div class="row">
                  ...
                  <div class="box-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="number" name="seating_capacity" value="{{old('seating_capacity') ?? 67 }}"  class="form-control {{ $errors->has('seating_capacity') ? ' is-invalid' : '' }}" id="seating-capacity" placeholder="Enter Seating Capacity">
                      ...
                      <div class="form-group col-md-6 ">
                        ...
                        <input id="front-seats" type="number" name="first_row_count" value="{{old('first_row_count') ?? 2 }}"  class="form-control {{ $errors->has('first_row_count') ? ' is-invalid' : '' }}" required>
                  ...
                  <div class="form-group col-md-6 ">
                    ...
                    <input type="text" name="offset_seats" value="{{old('offset_seats')}}"  class="form-control {{ $errors->has('offset_seats') ? ' is-invalid' : '' }}" id="exampleInputEmail1" >
