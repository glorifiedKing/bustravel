                            ...
                            <tr>
                              <td>@if($bus->status==1)
                                ...
                                <td><a title="Edit" href="{{route('bustravel.buses.edit',$bus->id)}}"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                    <a title="Delete" onclick="return confirm('Are you sure you want to delete this Bus')" href="{{route('bustravel.buses.delete',$bus->id)}}"><span style="color:tomato"><i class="fas fa-trash-alt" aria-hidden="true"></i></span></a>
                                </td>
                            </tr>
