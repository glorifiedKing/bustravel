...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card">
            ...
            <h5 class="card-title">Add Printer</h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body">               
            <div class="row">
              ...
              <div class="box-body">                
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input name="printer_name" value="{{old('printer_name') ?? 'palmkash_printer'}}" class="form-control {{ $errors->has('printer_name') ? 'is-invalid' : '' }}" >
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input name="printer_url" value="{{old('printer_url') ?? 'rawbt:base64'}}" class="form-control {{ $errors->has('printer_url') ? 'is-invalid' : '' }}" >
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input name="printer_port" value="{{old('printer_port') ?? '9100'}}" class="form-control {{ $errors->has('printer_port') ? 'is-invalid' : '' }}" >
